    ...
    <main style="padding-bottom: 50px;">
        <table style="width:100%;border-collapse:collapse;border-spacing:0;margin-bottom:20px;border: 1px solid #eee;">
            ...
            <tbody>
                ...
                <tr style="background: #F5F5F5">
                    <td style="padding-left: 15px;text-align: center;vertical-align: top;"></td>
                    <td style="padding-left: 15px;text-align: left;vertical-align: top;">Pembelian Produk
                ...
                <tr>
                    ...
                    <td style="padding-top: 7px;padding-right: 15px;text-align: right;font-size: 1.2em;">Rp.
                        {{convert_to_rupiah($transaksi->total_price + 5000)}}</td>
                </tr>
                <tr>
