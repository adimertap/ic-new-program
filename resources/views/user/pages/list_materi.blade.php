        ...
        <div class="container-fluid">
            ...
            <div class="brevet">
                ...
                @if ($materi != null && $reqSertif != 1)
                    ...
                    $materi->keranjang[0]['payment_status'] ==
                    'Paid')
                    <div class="col-lg-2">
                        <div class="text-center d-block bg-warning rounded ">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type" id="type_radio" value="Manual" checked>
                    ...
                    <div class="col-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type" id="type_radio" value="Otomatis">
                            <label class="form-check-label" for="type_radio">
                                Otomatis
                            </label>
                          </div>
