                ...
                <div class="brevet">
                    ...
                    <form action="" id="form" method="POST">
                      ...
                      <input type="hidden" name="soal_id" value="{{ $item->id }}"> 
                        <p class="mt-5" style="line-height: 30px; font-size:1.1rem"><b
                                class="number mr-3">{{ $index + 1 }}.</b>
                            {{ $item->soal }}</p>
                        <div class="ml-3 pt-1 mt-3">
                            <div class="form-check">
                                <input class="form-check-input" id="flexRadioDefault1" type="radio" name="jawaban"
                                    value="a" {{ $item->jawaban_user === 'a' ? 'checked' : '' }} />
                        ...
                        <div class="mt-5 pagination"
                            style="margin-top:150px!important;display: flex; justify-content: center;">
                            <nav role="navigation" aria-label="Pagination Navigation"
                                ...
                                <div class="flex">
                                    ...
                                    @if (!$soal->hasMorePages())
                                        ...
                                        <form id="form_save" 
                                        action="{{ route('simpanJawaban') }}" method="POST" style="display: none">
