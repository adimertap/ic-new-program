      ...
      <div class="row">
        <div class="col">
          <div class="section-description section-description-inline d-flex justify-content-between">
            <h5>Transaksi <b class="text-primary">Manual</b> Berdasarkan Instansi</h5>
          </div>
                    ...
                    <tbody class="list">
                        ...
                        <tr role="row" class="odd ">
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin-keranjang-produk-detail', $item->id) }}" class="btn btn-sm btn-primary text-center editBtn"
