                                ...
                                <td>
                                    <div class="text-author">
                                        ...
                                        <p style="color: black; line-height: 1.7">Pendaftaran Anda sudah kami terima, terimakasih atas kepercayaannya untuk
                                            ...
                                            dipersilahkan
                                            untuk melakukan pembayaran sesuai dengan invoice
                                            terlampir berikut ini </p>
                                        <p  style="color: black; line-height: 1.7"> Anda dapat mengakses link pembayaran pada url berikut ini: {{ $link }}.</p>
                                        @endif
                                        <p style="color: black; line-height: 1.7"> Link akan valid selama 1 hari atau 24 Jam, jika melewati batas waktu tersebut link akan kedaluarsa dan Anda diharuskan melakukan checkout ulang kembali pada portal.
