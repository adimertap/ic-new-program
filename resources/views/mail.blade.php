  ...
  <table border="0">
    ...
    <tr>
      <td>Pendaftaran Anda sudah kami terima, terimakasih atas kepercayaannya untuk mengikuti {{$produk}} di IC
        ...
        untuk melakukan pembayaran (via transfer bank) sesuai dengan invoice terlampir berikut ini </td>
    </tr>
    @endif
    <tr>
      <td>Jika sudah melakukan pembayaran (via transfer) diharapkan melampirkan screenshot bukti pembayaran (transfer)
        melalui whatsapp <a href="https://api.whatsapp.com/send?phone=+62 811-1474-251">+62 811-1474-251</a> atau email
    ...
    @if(!empty($username))
    <tr>
      <td>Terima kasih, registrasi akun berhasil dilakukan</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
