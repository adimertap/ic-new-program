...
<body style="height: 100vh">
    ...
    <section class="register-user">
        ...
        <div class="right-kelengkapan">
            <div class="form-kelengkapan">
                <form action="{{ route('register-data-update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-register">
                        ...
                        <div class="form-check mt-3">
                            ...
                            <label class="form-label" for="exampleCheck1">Data yang saya inputkan benar apa
                                adanya</label>
                        </div>

                    </div>
                    <div class="d-flex justify-content-between mt-form-5">
                        ...
                        <button class="btn btn-register btn-margin-top" 
                            type="submit">Lanjut
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myForm" name="myForm" class="form-horizontal"
                        action="{{ route('register-data-instansi')}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="kerjasama" class="form-label small">Jenis <span class="mr-4 mb-3"
                        ...
                        <div class="form-group mt-3">
                            <label for="nama" class="form-label small">Nama Instansi <span class="mr-4 mb-3"
                                    style="color: red">*</span></label>
                            <input name="nama" type="text" class="form-control form-control-sm"
                                value="{{ Auth::user()->phone ?? '' }}" id="nama" placeholder="Masukan Nama Instansi .."
                                required>
                            <hr class="mt-3">
                            <div class="mt-4">
